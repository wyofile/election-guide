...
export const PARTIES = [
  { key: 'REP', noun: 'Republican', adjective: 'Republican', color: '#d73027', gradientLeft: 'linear-gradient(to bottom, #ffffff 0%,#ffffff 13%,#ff1e1e 100%)', gradientRight: 'linear-gradient(to bottom, #ffffff 0%,#ffffff 15%,#fffdfd 16%,#ff2727 100%)' },
  { key: 'DEM', noun: 'Democrat', adjective: 'Democratic', color: '#4575b4', gradientLeft: 'linear-gradient(to bottom, #fefefe 0%,#fcfefe 11%,#30c8dc 100%)', gradientRight: 'linear-gradient(to bottom, #fefefe 0%,#fefefe 8%,#fafdfd 10%,#2ac6db 100%)' },
